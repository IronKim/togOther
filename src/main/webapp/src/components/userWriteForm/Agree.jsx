...
const dataList = [
    {id:1, name:'chk1', text:'연령(만 14세 이상) 확인(필수)',
    textarea: ``,
    isChk:false},
    {id:2, name:'chk2', text:'togOther 이용약관(필수)',
  ...
  제24조(재판권 및 준거법)
    ...
    isChk:false},
    {id:3, name:'chk3', text:'개인정보 수집 및 이용 동의(필수)',
    textarea: `개인정보처리방침
    ...
    isChk:false},
    {id:4, name:'chk4', text:'이벤트 등 프로모션 알림 메일 수신 (선택)',
    textarea: ``,
    isChk:false},
]
